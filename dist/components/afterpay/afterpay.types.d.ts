...
export interface AfterpayButtonProps extends Omit<Square.AfterpayButtonOptions, 'useCustomButton'>, React.ComponentPropsWithoutRef<'div'> {
...
export interface AfterpayWidgetProps extends Square.AfterpayCheckoutWidgetOptions, React.ComponentPropsWithoutRef<'div'> {
}
//# sourceMappingURL=afterpay.types.d.ts.map